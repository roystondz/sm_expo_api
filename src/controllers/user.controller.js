...
export const syncUser = asyncHandler(async(req,res)=>{
    ...
    if(existinguser) return res.status(200).json({user:existinguser,message:"User already exists and synced"});
    ...
    if(!newUser) return res.status(400).json({error:"Could not create user"});
